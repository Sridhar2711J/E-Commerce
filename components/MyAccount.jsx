...
function MyAccount({isMyAccount, setIsMyAccount,user}) {
  ...
  return (
     <div className={`absolute top-[120px] right-5 bg-white px-10 py-5 rounded-2xl z-10 shadow-[0_0_5px_#656565] flex flex-col items-center ${isMyAccount ?"translate-x-0":"translate-x-2000"} animate-fade`}>
